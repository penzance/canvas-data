...
public class ModelClassGenerator {
  ...
  private final TableVersion previousVersion;
  private final String className;
  private final String previousClassName;

  public ModelClassGenerator(final String schemaVersion, final TableVersion tableVersion,
      final TableVersion previousVersion, final CanvasDataSchemaTable table) {
  ...
  private void outputImportStatements(final PrintStream out) {
    ...
    if (previousVersion != null && !table.getNewGenerated()) {
      out.println("import " + previousVersion.getPackageName() + "." + previousClassName + ";");
      out.println();
    }
  }
